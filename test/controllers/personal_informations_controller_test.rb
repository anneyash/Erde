...
class PersonalInformationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personal_information" do
    assert_difference('PersonalInformation.count') do
      post personal_informations_url, params: { personal_information: { body: @personal_information.body, title: @personal_information.title } }
    end
  ...
  test "should update personal_information" do
    patch personal_information_url(@personal_information), params: { personal_information: { body: @personal_information.body, title: @personal_information.title } }
